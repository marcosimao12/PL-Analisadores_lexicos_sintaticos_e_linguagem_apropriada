...
_lr_productions = [
  ...
  ('lista_declaracoes -> declaracao','lista_declaracoes',1,'p_lista_declaracoes','fca_grammar.py',36),
  ('lista_declaracoes -> lista_declaracoes declaracao','lista_declaracoes',2,'p_lista_declaracoes','fca_grammar.py',37),
  ('declaracao -> declaracao_atribuicao','declaracao',1,'p_declaracao','fca_grammar.py',45),
  ('declaracao -> declaracao_expressao','declaracao',1,'p_declaracao','fca_grammar.py',46),
  ('declaracao -> declaracao_funcao','declaracao',1,'p_declaracao','fca_grammar.py',47),
  ('declaracao -> declaracao_funcao_literal','declaracao',1,'p_declaracao','fca_grammar.py',48),
  ('declaracao -> declaracao_escrever','declaracao',1,'p_declaracao','fca_grammar.py',49),
  ('declaracao -> declaracao_comentario','declaracao',1,'p_declaracao','fca_grammar.py',50),
  ('declaracao -> declaracao_multiplas_atribuicoes','declaracao',1,'p_declaracao','fca_grammar.py',51),
  ...
  ('declaracao_funcao -> FUNC VARID ( parametros ) : lista_declaracoes FIM','declaracao_funcao',8,'p_declaracao_funcao','fca_grammar.py',63),
  ('declaracao_funcao -> FUNC VARID ( parametros ) , : expressao ;','declaracao_funcao',9,'p_declaracao_funcao','fca_grammar.py',64),
  ('declaracao_funcao_literal -> FUNC VARID ( NUM ) , : expressao ;','declaracao_funcao_literal',9,'p_declaracao_funcao_literal','fca_grammar.py',71),
  ('declaracao_escrever -> PRINT ( expressao ) ;','declaracao_escrever',5,'p_declaracao_escrever','fca_grammar.py',75),
  ('declaracao_comentario -> COMMENT_SINGLE_LINE','declaracao_comentario',1,'p_declaracao_comentario','fca_grammar.py',79),
  ('declaracao_comentario -> COMMENT_MULTI_LINE','declaracao_comentario',1,'p_declaracao_comentario','fca_grammar.py',80),
  ('declaracao_multiplas_atribuicoes -> lista_atribuicoes ;','declaracao_multiplas_atribuicoes',2,'p_declaracao_multiplas_atribuicoes','fca_grammar.py',88),
  ('lista_atribuicoes -> atribuicao','lista_atribuicoes',1,'p_lista_atribuicoes','fca_grammar.py',120),
  ('lista_atribuicoes -> lista_atribuicoes , atribuicao','lista_atribuicoes',3,'p_lista_atribuicoes','fca_grammar.py',121),
  ('atribuicao -> VARID = expressao','atribuicao',3,'p_atribuicao','fca_grammar.py',129),
  ('lista_expressoes -> expressao','lista_expressoes',1,'p_lista_expressoes','fca_grammar.py',133),
  ('lista_expressoes -> lista_expressoes , expressao','lista_expressoes',3,'p_lista_expressoes','fca_grammar.py',134),
  ('expressao -> expressao CONCAT expressao','expressao',3,'p_expressao_concat','fca_grammar.py',143),
  ('expressao -> STRING','expressao',1,'p_expressao_string','fca_grammar.py',147),
  ('expressao -> expressao + expressao','expressao',3,'p_expressao_plus','fca_grammar.py',155),
  ('expressao -> expressao - expressao','expressao',3,'p_expressao_minus','fca_grammar.py',159),
  ('expressao -> expressao * expressao','expressao',3,'p_expressao_times','fca_grammar.py',163),
  ('expressao -> expressao / expressao','expressao',3,'p_expressao_divide','fca_grammar.py',167),
  ('expressao -> ( expressao )','expressao',3,'p_expressao_group','fca_grammar.py',171),
  ('expressao -> - expressao','expressao',2,'p_expressao_uminus','fca_grammar.py',175),
  ('expressao -> VARID','expressao',1,'p_expressao_var_id','fca_grammar.py',179),
  ('expressao -> NUM','expressao',1,'p_expressao_num','fca_grammar.py',183),
  ('expressao -> [ ]','expressao',2,'p_expressao_list','fca_grammar.py',187),
  ('expressao -> [ lista_expressoes ]','expressao',3,'p_expressao_list','fca_grammar.py',188),
  ('expressao -> VARID ( lista_expressoes )','expressao',4,'p_expressao_chamada_funcao','fca_grammar.py',198),
  ('expressao -> ENTRADA ( )','expressao',3,'p_expressao_chamada_funcao','fca_grammar.py',199),
  ('expressao -> ALEATORIO ( expressao )','expressao',4,'p_expressao_chamada_funcao','fca_grammar.py',200),
  ('expressao -> MAP ( VARID , expressao )','expressao',6,'p_expressao_map','fca_grammar.py',211),
  ('expressao -> FOLD ( VARID , expressao , expressao )','expressao',8,'p_expressao_fold','fca_grammar.py',215),
  ('parametros -> VARID','parametros',1,'p_parametros','fca_grammar.py',221),
  ('parametros -> parametros , VARID','parametros',3,'p_parametros','fca_grammar.py',222),
  ('parametros -> [ ]','parametros',2,'p_parametros','fca_grammar.py',223),
  ('parametros -> VARID : VARID','parametros',3,'p_parametro_id_array','fca_grammar.py',233),
]
