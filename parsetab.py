...
_lr_productions = [
  ...
  ('lista_declaracoes -> declaracao','lista_declaracoes',1,'p_lista_declaracoes','fca_grammar.py',40),
  ('lista_declaracoes -> lista_declaracoes declaracao','lista_declaracoes',2,'p_lista_declaracoes','fca_grammar.py',41),
  ('declaracao -> declaracao_atribuicao','declaracao',1,'p_declaracao','fca_grammar.py',52),
  ('declaracao -> declaracao_expressao','declaracao',1,'p_declaracao','fca_grammar.py',53),
  ('declaracao -> declaracao_funcao','declaracao',1,'p_declaracao','fca_grammar.py',54),
  ('declaracao -> declaracao_funcao_literal','declaracao',1,'p_declaracao','fca_grammar.py',55),
  ('declaracao -> declaracao_escrever','declaracao',1,'p_declaracao','fca_grammar.py',56),
  ('declaracao -> declaracao_comentario','declaracao',1,'p_declaracao','fca_grammar.py',57),
  ('declaracao -> declaracao_multiplas_atribuicoes','declaracao',1,'p_declaracao','fca_grammar.py',58),
  ('declaracao_atribuicao -> VARID = expressao ;','declaracao_atribuicao',4,'p_declaracao_atribuicao','fca_grammar.py',62),
  ('declaracao_expressao -> expressao ;','declaracao_expressao',2,'p_declaracao_expressao','fca_grammar.py',66),
  ('declaracao_funcao -> FUNC VARID ( parametros ) : lista_declaracoes FIM','declaracao_funcao',8,'p_declaracao_funcao','fca_grammar.py',70),
  ('declaracao_funcao -> FUNC VARID ( parametros ) , : expressao ;','declaracao_funcao',9,'p_declaracao_funcao','fca_grammar.py',71),
  ('declaracao_funcao_literal -> FUNC VARID ( NUM ) , : expressao ;','declaracao_funcao_literal',9,'p_declaracao_funcao_literal','fca_grammar.py',78),
  ('declaracao_escrever -> PRINT ( expressao ) ;','declaracao_escrever',5,'p_declaracao_escrever','fca_grammar.py',82),
  ('declaracao_comentario -> COMMENT_SINGLE_LINE','declaracao_comentario',1,'p_declaracao_comentario','fca_grammar.py',86),
  ('declaracao_comentario -> COMMENT_MULTI_LINE','declaracao_comentario',1,'p_declaracao_comentario','fca_grammar.py',87),
  ('declaracao_multiplas_atribuicoes -> lista_atribuicoes ;','declaracao_multiplas_atribuicoes',2,'p_declaracao_multiplas_atribuicoes','fca_grammar.py',95),
  ('lista_atribuicoes -> atribuicao','lista_atribuicoes',1,'p_lista_atribuicoes','fca_grammar.py',128),
  ('lista_atribuicoes -> lista_atribuicoes , atribuicao','lista_atribuicoes',3,'p_lista_atribuicoes','fca_grammar.py',129),
  ('atribuicao -> VARID = expressao','atribuicao',3,'p_atribuicao','fca_grammar.py',137),
  ('lista_expressoes -> expressao','lista_expressoes',1,'p_lista_expressoes','fca_grammar.py',141),
  ('lista_expressoes -> lista_expressoes , expressao','lista_expressoes',3,'p_lista_expressoes','fca_grammar.py',142),
  ('expressao -> expressao CONCAT expressao','expressao',3,'p_expressao_concat','fca_grammar.py',150),
  ('expressao -> STRING','expressao',1,'p_expressao_string','fca_grammar.py',154),
  ('expressao -> expressao + expressao','expressao',3,'p_expressao_plus','fca_grammar.py',162),
  ('expressao -> expressao - expressao','expressao',3,'p_expressao_minus','fca_grammar.py',166),
  ('expressao -> expressao * expressao','expressao',3,'p_expressao_times','fca_grammar.py',170),
  ('expressao -> expressao / expressao','expressao',3,'p_expressao_divide','fca_grammar.py',174),
  ('expressao -> ( expressao )','expressao',3,'p_expressao_group','fca_grammar.py',178),
  ('expressao -> - expressao','expressao',2,'p_expressao_uminus','fca_grammar.py',182),
  ('expressao -> VARID','expressao',1,'p_expressao_var_id','fca_grammar.py',186),
  ('expressao -> NUM','expressao',1,'p_expressao_num','fca_grammar.py',190),
  ('expressao -> [ ]','expressao',2,'p_expressao_list','fca_grammar.py',194),
  ('expressao -> [ lista_expressoes ]','expressao',3,'p_expressao_list','fca_grammar.py',195),
  ('expressao -> VARID ( lista_expressoes )','expressao',4,'p_expressao_chamada_funcao','fca_grammar.py',205),
  ('expressao -> ENTRADA ( )','expressao',3,'p_expressao_chamada_funcao','fca_grammar.py',206),
  ('expressao -> ALEATORIO ( expressao )','expressao',4,'p_expressao_chamada_funcao','fca_grammar.py',207),
  ('expressao -> MAP ( VARID , expressao )','expressao',6,'p_expressao_map','fca_grammar.py',220),
  ('expressao -> FOLD ( VARID , expressao , expressao )','expressao',8,'p_expressao_fold','fca_grammar.py',224),
  ('parametros -> VARID','parametros',1,'p_parametros','fca_grammar.py',231),
  ('parametros -> parametros , VARID','parametros',3,'p_parametros','fca_grammar.py',232),
  ('parametros -> [ ]','parametros',2,'p_parametros','fca_grammar.py',233),
  ('parametros -> VARID : VARID','parametros',3,'p_parametro_id_array','fca_grammar.py',243),
]
